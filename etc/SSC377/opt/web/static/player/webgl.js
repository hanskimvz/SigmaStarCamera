...
WebGLPlayer.prototype.initGL = function (options) {
    ...
    var fragmentShaderSource = [
        ...
        ");",
        "void main(void) {",
        " gl_FragColor = vec4( texture2D(YTexture, vTextureCoord).r,",
        " texture2D(UTexture, vTextureCoord).r, ",
        "texture2D(VTexture, vTextureCoord).r, 1) * YUV2RGB;",
        "}"
    ].join("\n");
...
// WebGLPlayer.prototype.drawScene = function (frame) {
